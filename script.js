...
window.onmousemove = e => {
    ...
    const percentage = (mouseDelta / maxDelta) * -100, nextPercentageX = parseFloat(track.dataset.prevPercentage) + percentage, nextPercentage = Math.max(Math.min(nextPercentageX, 0), -100);
